...
public class GetFundTransferorOrderByPageRequest extends PageableRequest {
	...
	/**
	 * @param fundTransferorOrderNo 转让交易单号（仅供关联查询用）
     * @occurs 
	 */
	public void setFundTransfereorOrderNo(String fundTransferorOrderNo) {
